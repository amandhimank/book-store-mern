  ...
  return (
    <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row ">
      <div className="banner-left order-2 md:order-1 md:w-1/2 w-full flex flex-col md:gap-8 gap-4">
        <h1 className="text-black dark:text-zinc-300 text-[4.3vh] tracking-tighter leading-none md:text-5xl font-medium mt-7 md:mt-32">
        ...
        <label className="input input-bordered input-success flex items-center gap-2 bg-transparent">
          ...
          <input type="text" className="grow dark:text-zinc-300 text-black font-semibold" placeholder="Email" />
        </label>
